...
/* Mouse example: open the mouse driver and print the accumulated movement and
 * button state. The driver returns the movement since the last read in X and Y,
 * both reset afterwards. The device is opened by its name, "#MOUS". */
int main(void) {
    zos_dev_t dev;
