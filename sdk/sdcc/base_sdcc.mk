...
#	include $(ZOS_PATH)/sdk/sdcc/base_sdcc.mk
...
ZOS_INCLUDE=$(ZOS_PATH)/sdk/sdcc/include/
...
CRT_REL=$(ZOS_PATH)/sdk/sdcc/bin/zos_crt0.rel
...
LDFLAGS = -n -mjwx -i -b _HEADER=0x4000 -k $(ZOS_PATH)/sdk/sdcc/lib -l z80 $(ZOS_LDFLAGS)
