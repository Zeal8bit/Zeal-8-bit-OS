...
* Start the configuration with `cmake -B build` then `cmake --build build --target menuconfig`, at the root of this project
...
Once the build finishes, the file `build/os.bin` is the one to use as a ROM for the TRS-80.
